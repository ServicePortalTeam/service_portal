...
<div id="header-wrapper">
	...
	<?php if (!$is_admin): ?>
		<div id="authorize">
      		      <ul><?php global $user; if ($user->uid != 0) { print '<li class="first">' .t('Logged in as '). '<a href="' .url('user/'.$user->uid). '">' .$user->name. '</a></li>'; print '<li><a href="' .url('user/logout'). '">' .t('Logout'). '</a></li>'; } else { print '<li class="first"><a href="' .url('saml_login'). '">' .t('Login'). '</a></li>'; print '<li><a href="' .url('saml_login'). '">' .t('Register'). '</a></li>'; } ?></ul>
		</div>
	<?php endif; ?>
...
<div class="slideshow">
<img src="<?php print $base_path . $directory; ?>/images/slideshows/sea.jpg" width="939" height="175" alt="slideshow 1"/>
<img src="<?php print $base_path . $directory; ?>/images/slideshows/noon.jpg" width="939" height="175" alt="slideshow 2"/>
<img src="<?php print $base_path . $directory; ?>/images/slideshows/snow.jpg" width="939" height="175" alt="slideshow 3"/>
</div>
</div>
</div>
<?php endif; ?>
